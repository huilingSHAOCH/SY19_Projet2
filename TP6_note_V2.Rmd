...
error
```
On obtient l'erreur de test 0.0588. Elle est donc nettement meilleure que celle obtenue auparavant.
...
On obtient l'erreur de test 0.0576. Ici on prend mtry = sqrt(p) = 4.
...
On obtient l'erreur ????? => trop long : je n'ai pas pu run la fonction tune suffisamment longtemps pour obtenir un résultat.
...
On obtient l'erreur 0.087 pour un cout de 1 et un gamma de 0.1.
