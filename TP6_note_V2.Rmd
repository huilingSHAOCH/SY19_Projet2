...
Ici on n'est pas sûr s'il faut appliquer FDA pour les données. Donc on compare les erreurs estimées de QDA sans FDA et avec FDA : 
```{r sans FDA}
#Generate train data and test data
data<-data_parole
set.seed(2000)
...
L'erreur avec FDA (0.08) est beaucoup plus petite que l'erreur sans FDA (0.39). Donc il faut appliquer FDA sur notre donnée.